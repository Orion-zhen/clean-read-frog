...
interface UnresolvedDialogProps extends DialogContentProps {
  open: boolean
}

export function UnresolvedDialog({ open, ...contentProps }: UnresolvedDialogProps) {
  return (
...
function DialogContent({ isConfirming, onConfirm, onCancelled }: DialogContentProps) {
  ...
  return (
    <AlertDialogContent className="flex max-h-[90vh] flex-col overflow-hidden data-[size=default]:max-w-[calc(100vw-2rem)] data-[size=default]:md:max-w-2xl data-[size=default]:lg:max-w-4xl data-[size=default]:xl:max-w-5xl">
      ...
      <AlertDialogFooter>
        <AlertDialogCancel disabled={isConfirming} onClick={onCancelled}>
